...
value="${user.nickname}"/></c:if>
</div>
</div>
</div>
<div style="clear: both;" />
You have a total number of ${fn:length(todos)}
Todos.
<table>
<tr>
...
<td><a class="done"
href="<c:url value="/done?id=${todo.id}"
/>">Done</a></td>
</tr>
</c:forEach>
</table>
...
<tr>
<td><label
for="summary">Summary</label></td>
<td><input type="text"
name="summary" id="summary" size="65" /></td>
</tr>
<tr>
<td valign="description"><label
...
<td><label
for="date">Date</label></td>
<td><input type="text"
name="date" id="date" size="65" /></td>
</tr>
